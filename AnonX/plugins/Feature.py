...
@app.on_message(
    command(["مميزات","مميزات الفراعنة "])
 )
async def mmmezat(client, message):
        await message.reply_text(f"""**مرحبآ بك عزيزي » {message.from_user.mention}**في قسم مميزات سورس الفراعنة  ميوزك\n
⩹━★⊷⌯⌞ ⩹━⊷⌯ ميوزك الفراعنة ⌝⌯⊶★━⩺

★قائمة مميزات سورس الفراعنة 
