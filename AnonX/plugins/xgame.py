...
GAME_MESSAGE = "⩹━★⊷━⌞ ميوزك الفراعنة ⌝━⊶★━⩺\n\n★¦ مرحبا بك عزيزي:\n★¦في قسم العاب الفراعنة \n\n⩹━★⊷━⌞ ميوزك الفراعنة ⌝━⊶★━⩺"
GAME_BUTTONS = [
    [ 
        InlineKeyboardButton ('★¦العاب 3D', callback_data= 'GAME1'),
        InlineKeyboardButton ('سورس الفراعنة ', callback_data= 'GAME2'),
        ],[
        InlineKeyboardButton ('⌞ ميوزك الفراعنة ⌝⚡️', url =f"https://t.me/wasit_go")              
                 ],[
...
async def callback_query(client, CallbackQuery):
          if CallbackQuery.data == "GAME1":
             ...
             GAME1_MESSAGE = "⩹━★⊷━⌞ ميوزك الفراعنة ⌝━⊶★━⩺\n\nمرحبا بك في قسم العاب الفراعنة 3D\n\n⩹━★⊷━⌞ ميوزك الفراعنة ⌝━⊶★━⩺"
             ...
             await CallbackQuery.edit_message_text( 
               ...
               RETURN_GAME = "⩹━★⊷━⌞ ميوزك الفراعنة ⌝━⊶★━⩺\n\n★¦مرحبا بك في قسم العاب الفراعنة \n★¦اختار ما تشاء من الالعاب مسليه وستمتع بها\n\n⩹━★⊷━⌞ ميوزك الفراعنة ⌝━⊶★━⩺" 

               RETURN_BUTTON = [
                    [ 
                      InlineKeyboardButton ('★¦العاب 3D', callback_data= 'GAME1'),
                      InlineKeyboardButton ('★¦العاب الفراعنة ', callback_data= 'GAME2')
                      ],[
        InlineKeyboardButton ('⌞ ميوزك الفراعنة ⌝⚡️', url =f"https://t.me/wasit_go")              
                 ],[
                InlineKeyboardButton(
